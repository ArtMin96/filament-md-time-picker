    ...
    var MDTimePicker = /*#__PURE__*/function () {
        ...
        function MDTimePicker(el, config) {
            ...
            this.timepicker = {
                ...
                clockHolder: {
                    wrapper: hf.createElem('section', {
                        class: 'mdtp__clock_holder bg-white dark:bg-gray-900 text-gray-900 dark:text-white'
                    }),
                    ...
                    clock: {
                        wrapper: hf.createElem('div', {
                            class: 'mdtp__clock dark:bg-gray-950'
                        }),
                    ...
                    buttonsHolder: {
                        ...
                        btnClear: hf.createElem('button', {
                            class: 'mdtp__button clear-btn',
                            style:'--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);',
                        }, 'Clear'),
                        btnOk: hf.createElem('button', {
                            class: 'mdtp__button ok fi-btn fi-btn-size-md relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus:ring-2 rounded-lg fi-btn-color-primary gap-1.5 px-3 py-2 text-sm inline-grid shadow-sm bg-custom-600 text-white hover:bg-custom-500 dark:bg-custom-500 dark:hover:bg-custom-400 focus:ring-custom-500/50 dark:focus:ring-custom-400/50 fi-ac-btn-action text-white',
                            style:'--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);',
                        }, this.config.okLabel),
                        btnCancel: hf.createElem('button', {
                            class: 'mdtp__button cancel fi-btn fi-btn-size-md relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus:ring-2 rounded-lg fi-btn-color-gray gap-1.5 px-3 py-2 text-sm inline-grid shadow-sm bg-white text-gray-950 hover:bg-gray-50 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 ring-1 ring-gray-950/10 dark:ring-white/20 fi-ac-btn-action',
                            style:'--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);',
